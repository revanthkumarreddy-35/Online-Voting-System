...
public class DatabaseSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if (userRepository.findByUsername("masteradmin") == null) {
            ...
            masterAdmin.setStatus(com.auca.onlinevotingsystem.model.UserStatus.APPROVED);
        ...
        if (userRepository.findByUsername("admin1") == null) {
            ...
            admin.setStatus(com.auca.onlinevotingsystem.model.UserStatus.APPROVED);
        ...
        if (userRepository.findByUsername("voter1") == null) {
            ...
            voter.setStatus(com.auca.onlinevotingsystem.model.UserStatus.APPROVED);
